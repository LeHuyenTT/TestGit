...
static void nms_sorted_bboxes(const std::vector<FaceObjectMesh> &faceobjects,
...
int FaceMeshService::detect(const cv::Mat &rgb, std::vector<FaceObjectMesh> &faceobjects,
    ...
    ncnn::Mat in =
        ncnn::Mat::from_pixels_resize(rgb.data, ncnn::Mat::PIXEL_RGB, width, height, w, h);
...
void FaceMeshService::seg(cv::Mat &rgb, const FaceObjectMesh &obj, cv::Mat &mask, cv::Rect &box) {
    ...
    ncnn::Mat       ncnn_in      = ncnn::Mat::from_pixels_resize(
        faceRoiImage.data, ncnn::Mat::PIXEL_RGB, faceRoiImage.cols, faceRoiImage.rows, 256, 256);
...
void FaceMeshService::landmark(cv::Mat &rgb, const FaceObjectMesh &obj,
    ...
    ncnn::Mat       ncnn_in      = ncnn::Mat::from_pixels_resize(
        faceRoiImage.data, ncnn::Mat::PIXEL_RGB, faceRoiImage.cols, faceRoiImage.rows, 192, 192);
...
int FaceMeshService::draw(cv::Mat &rgb, const std::vector<FaceObjectMesh> &faceobjects) {
    ...
    // static const unsigned char face_part_colors[8][3] = {{0, 0, 255}, {255, 85,
    // 0}, {255, 170, 0}, {255, 0, 85}, {255, 0, 170}, {0, 255, 0}, {170, 255,
    // 255}, {255, 255, 255}};
